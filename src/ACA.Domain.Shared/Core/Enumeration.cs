...
namespace ACA.Domain.Shared.Core
{
    ...
    public abstract class Enumeration : IComparable<Enumeration>
    {
        ...
        /// <summary>
        /// Checks if this enumeration member is equal to another object.
        /// </summary>
        ...
        /// <summary>
        /// Checks if the given ID corresponds to a defined enumeration member.
        /// </summary>
        /// <typeparam name="T">The type of enumeration.</typeparam>
        ...
        /// <summary>
        /// Checks if the given name corresponds to a defined enumeration member.
        /// </summary>
        /// <typeparam name="T">The type of enumeration.</typeparam>
